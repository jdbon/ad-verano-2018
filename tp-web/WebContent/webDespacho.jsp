    ...
    <div class="container">
      <div class="row">
        <div class="intro-text">
          ...
          <hr>
          <font color="red"><p>Modulo de Despachos</p></font>
 		 
<p></p><a href="Controlador?accion=aprobarPedidos" class="btn btn-default btn-lg page-scroll">Aprobar / Rechazar Pedidos</a>
